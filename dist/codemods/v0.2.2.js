const MOCK_JWT = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsImV4cCI6OTk5OTk5OTk5OX0.fake';
...
blob-report/
.playwright/`;
function addPlaywrightToPackageJson(content) {
...
const codemod = {
    ...
    transforms: [
        ...
        {
            file: '.gitignore',
            transform: (content) => content.includes('# Playwright') ? content : content + gitignoreAdditions + '\n',
        },
    ],
};
